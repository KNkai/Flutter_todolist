...
class _CategoriesPageState extends State<CategoriesPage> {
  final GlobalKey<ScaffoldState> _categoriesScaffoldKey = new GlobalKey<ScaffoldState>();
            ...
            onPressed: ()  {
              if(category!=null){
                setState(() async {
                  ...
                  var result = await _categories_service.updateCategory(category);
                  _modelCat.clear();
                  _getAllCategories();
                  print(100);
                  print(result);
                ...
                setState(() async {
                  ...
                  var result = await _categories_service.saveCategory(_category);
                  _modelCat.clear();
                  _getAllCategories();
                  print(100);
                  print(result);
                  ...
                  child: ListTile(
                    ...
                    onTap: (){
                      ...
                      Navigator.push(
                        context, 
                        MaterialPageRoute(
                          builder: (context)=>TodoDetail(category: cat,)
                        )
                      );
                    },
                  ),
